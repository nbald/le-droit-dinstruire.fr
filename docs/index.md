---
description: "Guide complet sur l'instruction en famille (IEF) : jurisprudence, motifs d'autorisation, recours contre les refus, contrôles. Analyse de 150+ décisions de justice."
keywords: "instruction en famille, IEF, école à la maison, autorisation IEF, jurisprudence IEF, refus IEF, recours tribunal administratif, éducation à domicile"
---
...
Depuis septembre 2022, instruire son enfant en famille nécessite une **autorisation préalable** du directeur académique des services de l'éducation nationale ([art. L. 131-5 du code de l'éducation](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000043982594)).
...
<div class="mobile-only" markdown>
...
!!! warning "Campagne 2026-2027 en cours"

    La période de dépôt des demandes d'autorisation pour la rentrée 2026-2027 est ouverte. Vous avez déjà soumis votre dossier ? Pas de panique : vous pouvez tout à fait [déposer une nouvelle demande renforcée](preparer/strategie.md#demandes-multiples-et-successives) à la lumière des informations de ce site. Aucun texte ne limite le nombre de demandes, et la jurisprudence le confirme.
...
- [Connaître son académie](preparer/academies.md) — taux de refus, tribunaux par tendance
- [Les allocations et l'IEF](preparer/allocations.md) — CAF, ARS, RSA
- [Ce qu'on risque vraiment](preparer/sanctions.md) — amendes, poursuites, contrôle judiciaire

## Contester un refus

!!! warning "J'ai reçu un refus"

    Vous avez **15 jours** pour saisir la commission RAPO. Ne laissez pas passer ce délai.

- [Vérifier la légalité du refus](contester/legalite-refus.md) — un vice de procédure peut suffire
- [Le RAPO](contester/rapo.md) — le recours obligatoire avant le tribunal
- [Le tribunal administratif](contester/tribunal-administratif.md) — le recours au fond
- [Le référé-suspension](contester/refere.md) — quand la rentrée approche
- [Combien de temps ça prend ?](contester/delais.md) — délais par juridiction et par ville
- [Se faire aider](contester/aide.md) — associations, aide juridictionnelle

## Le droit d'instruire en Europe

- [Ce que dit la Cour européenne des droits de l'homme](europe/cedh.md)
- [La France et ses voisins](europe/comparaison.md)

## Après l'autorisation

- [Le contrôle pédagogique](apres/controle-pedagogique.md) — vos droits, le déroulement, la contestation
- [L'enquête de mairie](apres/enquete-mairie.md) — ce que le maire peut et ne peut pas demander
- [Questions pratiques](apres/questions-pratiques.md) — allocations, examens, retour à l'école
...
[Qui sommes-nous](a-propos/index.md) · [Glossaire](a-propos/glossaire.md)
